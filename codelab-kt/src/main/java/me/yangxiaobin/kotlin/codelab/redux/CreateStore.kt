...
import me.yangxiaobin.kotlin.codelab.redux.utils.isPlainObject

/**
 * Creates a NON-THREADSAFE Redux store that holds the state tree.
 * If your application needs thread-safety access to store consider [org.reduxkotlin.createThreadSafeStore]
 * see:
