package me.yangxiaobin.image_edit.lib.model
...
class ClipViewModel(
     ...
     */
    fun close(view: View) {
        bindingRoot?.findViewById<View>(R.id.ed_tools)?.visibility = View.VISIBLE
        bindingRoot?.findViewById<View>(R.id.clip_view)?.visibility = View.GONE
        image?.cancelClip()
    }
