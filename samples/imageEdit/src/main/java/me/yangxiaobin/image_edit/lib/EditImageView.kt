package me.yangxiaobin.image_edit.lib
...
import me.yangxiaobin.image_edit.lib.anim.EditHomingAnimator
import me.yangxiaobin.image_edit.lib.core.EditImage
import me.yangxiaobin.image_edit.lib.core.EditImageArrows
import me.yangxiaobin.image_edit.lib.core.EditImageMode
import me.yangxiaobin.image_edit.lib.core.EditImagePath
...
class EditImageView @JvmOverloads constructor(
   ...
   //============================================= 对外api
    ...
    fun addStickerText(text: EditImageText?) {
        val textView = EditStickerTextView(context)
        textView.text = text
