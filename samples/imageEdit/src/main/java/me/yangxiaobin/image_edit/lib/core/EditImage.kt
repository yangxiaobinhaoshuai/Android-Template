...
import me.yangxiaobin.image_edit.lib.IS_DEBUG
import me.yangxiaobin.image_edit.lib.clip.EditClip
import me.yangxiaobin.image_edit.lib.clip.EditClipWindow
...
class EditImage {
     ...
     * 裁剪模式时当前触摸锚点
     */
    private var mAnchor: EditClip.Anchor? = null
