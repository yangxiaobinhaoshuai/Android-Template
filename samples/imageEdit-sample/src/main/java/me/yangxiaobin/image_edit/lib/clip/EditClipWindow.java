 ...
 * @date 2021/5/8 : 13:33
 */
public class EditClipWindow implements EditClip {
    ...
    private static final int COLOR_FRAME = Color.parseColor("#007EFA");  //边框的颜色

    private static final int COLOR_CORNER = Color.parseColor("#007EFA");  //边框4角的颜色
