...
public class EditColorRadio extends androidx.appcompat.widget.AppCompatRadioButton implements ValueAnimator.AnimatorUpdateListener {
    ...
    private static final float RADIUS_BASE = 0.4f;

    private static final float RADIUS_RING = 0.9f;

    private static final float RADIUS_BALL = 0.6f;
