...
/**
 * Deprecated reason see : https://developer.android.com/studio/releases/gradle-plugin-api-updates#transform-api
 */
class ExamplePlugin : Plugin<Project> {
    ...
    abstract class ExampleClassVisitorFactory : AsmClassVisitorFactory<ExampleParams> {
        ...
        override fun isInstrumentable(classData: ClassData): Boolean {
            return classData.className.startsWith("me.yangxiaobin")
        }
    }
}
