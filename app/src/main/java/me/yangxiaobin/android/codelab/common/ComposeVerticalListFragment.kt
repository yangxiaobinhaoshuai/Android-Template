...
import me.yangxiaobin.android.embedding_compat.SignatureFragment
...
import me.yangxiaobin.canvas.CanvasFragment
...
class ComposeVerticalListFragment : AbsComposableFragment() {
    ...
    fun naviToDestFragment(dest: String) {
        ...
        when (dest) {
            ...
            "CanvasFragment" -> naviToFragment(CanvasFragment())
